...
/*
Copyright (c) 2002-2017, 2019 by QUALCOMM Technologies, Incorporated.
All Rights Reserved.
...
/*===========================================================================
  ...
  $Header: //components/rel/core.tx/5.0/api/services/msgcfg.h#2 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
01/30/19   vg      Updated to VU_CORE_SERVICES_DIAG_DEFS_API.02.00.125
05/19/17   gn      Header file cleanup
09/22/16   as      Updated to VU_CORE_SERVICES_DIAG_DEFS_API.02.00.89
10/14/14   xy      Added new message SSIDs
...
#define MSG_SSID_SIMCOM      MSG_FIRST_TARGET_OEM_SSID //49152
#define MSG_SSID_SIMCOM_PUB  (MSG_SSID_SIMCOM+1)
#define MSG_SSID_SIMCOM_DEMO (MSG_SSID_SIMCOM+2)
#define MSG_SSID_SIMCOM_HTTP (MSG_SSID_SIMCOM+3)
