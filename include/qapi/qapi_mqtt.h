...
/** MQTT security mode. */
typedef enum {
  QAPI_MQTT_NO_SECURITY_MODE = 0,
  QAPI_MQTT_PSK = 1,/**< psk mode. */
  QAPI_MQTT_CERTIFICATE = 2,/**< qwes certificate mode. */
...
typedef enum {
  ...
  QAPI_NET_MQTT_EXTENDED_CONFIG_MAX = QAPI_NET_MQTT_EXTENDED_CONFIG_PASS_MSG_HEADER,
