...
$Header: //components/rel/core.tx/5.0/buses/api/uart/qapi_uart.h#5 $

when       who     what, where, why
--------    ---     --------------------------------------------------------
03/17/2020   ss     Moved API definition to respective source file.
...
int qapi_uart_rx_user_cb_dispatcher (UINT cb_id,void *pfnUser_cb, 
                                    int cb_param1, int cb_param2);
